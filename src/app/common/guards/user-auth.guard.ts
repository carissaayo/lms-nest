...
export class AuthenticateTokenUserGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const JWT_ACCESS_TOKEN_SECRET_USER =
      this.configService.get<string>('jwt.secret_user') || '';
...
export class ReIssueTokenUserGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const JWT_ACCESS_TOKEN_SECRET_USER = process.env
      .JWT_ACCESS_TOKEN_SECRET_USER as string;
    const JWT_REFRESH_TOKEN_SECRET_USER = process.env
      .JWT_REFRESH_TOKEN_SECRET_USER as string;
